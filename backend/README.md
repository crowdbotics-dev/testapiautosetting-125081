...
## Project Structure
    ...
    ├── testapiautosetting_125081  # Django project configurations
...
1. Clone this repo and `cd testapiautosetting_125081`
...
2. Clone this repo and `cd testapiautosetting_125081`
